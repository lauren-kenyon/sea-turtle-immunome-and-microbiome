...
library(stringr)
#Purpose: 
#1. Create a binary table of the immunomes and the prescence of (all) immune GO terms
#2. Compare presence pattern using MDS across immunomes
#3. Later repeat with immune categories
